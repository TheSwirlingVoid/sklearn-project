...
class OutputDisplay():
    ...
    def display_test_grid(self):
        ...
        print("Predictions: ", self.predictor.get_predictions())
        print("Corresponding Solutions: ", test_solutions)
        plt.show()
...
def main() -> None:
    ...
    print("Prediction accuracy: " + str(predictor.calculate_percent_accuracy()*100) + "%.")
